...
#watts to BTU
watts_to_BTU_converter= 3.412141633
...
lps_to_gpm_converter= 15.850323140625
...
print(f"{quantity:.2f} degrees Celsius is equivalent to {faren:.2f} degrees Fahrenheit")
